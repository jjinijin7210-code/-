...
import ShoppingShortsPlanning from './pages/ShoppingShortsPlanning'
  ...
  return (
    <Routes>
      ...
      >
        ...
        <Route path="card-news" element={<CardNews />} />
        <Route path="shopping-shorts" element={<ShoppingShortsPlanning />} />
